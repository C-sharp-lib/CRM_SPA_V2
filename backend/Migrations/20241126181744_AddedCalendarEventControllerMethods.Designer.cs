...
namespace backend.Migrations
{
    ...
    [Migration("20241126181744_AddedCalendarEventControllerMethods")]
    partial class AddedCalendarEventControllerMethods
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.CalendarEvent", b =>
                {
                    ...
                    b.Property<string>("JobsAssignedTo")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("JobsCreatedBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("JobsCustomerId")
                        .HasColumnType("int");

                    b.Property<int>("JobsJobId")
                        .HasColumnType("int");

                    b.Property<string>("JobsLastUpdatedBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("EventId", "CreatedBy", "EventFor");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("EventFor");

                    b.HasIndex("JobsJobId", "JobsAssignedTo", "JobsCustomerId", "JobsLastUpdatedBy", "JobsCreatedBy");
            ...
            modelBuilder.Entity("backend.Models.OrderItems", b =>
                {
                    ...
                    b.Property<string>("OrderLastUpdatedBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("OrderId1", "OrderCustomerId", "OrderUserId", "OrderLastUpdatedBy");
            ...
            modelBuilder.Entity("backend.Models.CalendarEvent", b =>
                {
                    ...
                    b.HasOne("backend.Models.Customers", "Customer")
                        .WithMany("Events")
                        .HasForeignKey("EventFor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend.Models.Jobs", "Jobs")
                        .WithMany("CalendarEvents")
                        .HasForeignKey("JobsJobId", "JobsAssignedTo", "JobsCustomerId", "JobsLastUpdatedBy", "JobsCreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.OrderItems", b =>
                {
                    ...
                    b.HasOne("backend.Models.Orders", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId1", "OrderCustomerId", "OrderUserId", "OrderLastUpdatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.Orders", b =>
                {
                    ...
                    b.HasOne("backend.Models.AppUser", "LastUpdatedByUser")
                        .WithMany()
