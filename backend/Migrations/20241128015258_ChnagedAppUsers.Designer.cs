...
namespace backend.Migrations
{
    ...
    [Migration("20241128015258_ChnagedAppUsers")]
    partial class ChnagedAppUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.LeadActivities", b =>
                {
                    ...
                    b.Property<string>("CreatedByUserAppUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CreatedByUserAppUserId");
            ...
            modelBuilder.Entity("backend.Models.LeadHistory", b =>
                {
                    ...
                    b.Property<string>("UpdatedByUserAppUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("LeadId", "LeadHistoryId", "UpdatedBy");

                    b.HasIndex("UpdatedByUserAppUserId");
            ...
            modelBuilder.Entity("backend.Models.TaskAttachments", b =>
                {
                    ...
                    b.Property<string>("UploadedByUserAppUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("UploadedByUserAppUserId");
            ...
            modelBuilder.Entity("backend.Models.LeadActivities", b =>
                {
                    b.HasOne("backend.Models.AppUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserAppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.LeadHistory", b =>
                {
                    ...
                    b.HasOne("backend.Models.AppUser", "UpdatedByUser")
                        .WithMany()
                        .HasForeignKey("UpdatedByUserAppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.TaskAttachments", b =>
                {
                    ...
                    b.HasOne("backend.Models.AppUser", "UploadedByUser")
                        .WithMany()
                        .HasForeignKey("UploadedByUserAppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
